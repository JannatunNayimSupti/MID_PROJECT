...
<body>
  ...
  <tr height="300px">
	...
	<td width="60%">
		<form>
            <fieldset>
    <legend><b>COMMENT BOX</b></legend>
    <form method="post">
        <table width="100%" cellpadding="0" cellspacing="0">
           <tr>

              <td colspan="4" width="100%">COMMENT BOX:<br>
                <textarea rows="4" cols="50" name="comment" form="usrform">
Enter Comment Here...</textarea><img width="150px" align="left" src="img/co.png"/> </td><br>
              
               

                <td colspan="4" width="50%"><br> <a href="comment.php">
                  <br>Want To Comment About The Customer?</a> 
                </td>
